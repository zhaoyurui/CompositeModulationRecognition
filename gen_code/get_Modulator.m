...
% get_Modulator  Return a modulator function handle for a given type.
%   MOD = get_Modulator(TYPE, SPS, FS) returns a function handle that
%   modulates an M-ary symbol column vector into a complex waveform.
