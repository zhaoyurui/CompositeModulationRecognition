%% main_dataset_hard.m
% Generate the Hard-level Compound Modulation Recognition dataset.
% Inner-layer: 8 types  (BPSK, QPSK, 8PSK, 16QAM, 32QAM, 64QAM, 128QAM, NONE)
% Outer-layer: 7 types  (LFM, 2FSK, 4FSK, 8FSK, MSK, GFSK, NONE)
% Total: 8*7-1 = 55 CM types, 2000 samples per type = 110,000 samples.
%
% Output: ./data/Modu01_8_Modu02_7_SampleNum_2000.mat
%   X  : [N, 2, SampleLen]  real/imag channels
%   Y1 : [N, 1]  inner-layer label index (1..8)
%   Y2 : [N, 1]  outer-layer label index (1..7)

clear; clc; close all;

ModuClass_01 = ["BPSK", "QPSK", "8PSK", "16QAM", "32QAM", "64QAM", "128QAM", "NONE"];
ModuClass_02 = ["LFM", "2FSK", "4FSK", "8FSK", "MSK", "GFSK", "NONE"];
...
save(['data/Modu01_8_Modu02_7_SampleNum_', num2str(SampleNum), '.mat'], ...
    'X', 'Y1', 'Y2', '-v7.3');
fprintf('Hard dataset saved: %d samples\n', N_total);
